...
そして勝手ながら、日本の VMware コミュニティのエキスパート、vExpert の皆さんで持ち回りで投稿しているアドベントカレンダー、[vExperts Advent Calendar 2021](https://adventar.org/calendars/6689) の 12/24 のコンテンツも兼ねさせていただきました。  
